package com.daop.member.controller;

import java.util.Arrays;
import java.util.Map;

import com.daop.member.feign.CouponFeignService;
...
import com.daop.member.service.MemberService;
...
public class MemberController {
    ...
    public R test() {
        ...
        memberEntity.setNickname("法外狂徒张三");
